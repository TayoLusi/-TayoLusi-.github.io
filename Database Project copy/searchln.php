...
$DBConnect = mysql_connect("itec315.frostburg.edu", "amibijemilusi0", "2954768");
	...
	else
	{
		...
		print "There isnt a DB called $DBName";
			...
			{
				echo"<p>Here is a list of last names in the database:</p>";
...
<form method="POST" action = "searchlasthandler.php">
<p>Please search last name: <input type = "text" name = "LastName" /></p>
